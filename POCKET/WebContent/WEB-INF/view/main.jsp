...
<head>
	...
	<link href="/bootstrap/user/plugins/flexslider/flexslider.css" rel="stylesheet" media="screen" />
	<link href="/bootstrap/user/css/cubeportfolio.min.css" rel="stylesheet" />
	<link href="/bootstrap/user/css/style.css" rel="stylesheet" />

	<!-- Theme skin -->
	<link id="t-colors" href="/bootstrap/user/skins/default.css" rel="stylesheet" />

	<!-- boxed bg -->
	<link id="bodybg" href="/bootstrap/user/bodybg/bg1.css" rel="stylesheet" type="text/css" />
...
<body>
			...
			<div class="navbar navbar-default navbar-static-top">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="/main.do"><img src="/bootstrap/user/img/bloodDrop.png" alt="" width="50" height="50" /></a>
					</div>	
						...
						<ul class="nav navbar-nav">
							<li class="dropdown active">
								...
								<ul class="dropdown-menu">
									<li><a href="/bootstrap/user/index.html">Home slider 1</a></li>
									<li><a href="/bootstrap/user/index2.html">Home slider 2</a></li>
								</ul>
							</li>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="/bootstrap/user/typography.html">Typography</a></li>
									<li><a href="/bootstrap/user/components.html">Components</a></li>
									<li><a href="/bootstrap/user/pricing-box.html">Pricing box</a></li>
									<li class="dropdown-submenu">
										<a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown">Pages</a>
										<ul class="dropdown-menu">
											<li><a href="/bootstrap/user/fullwidth.html">Full width</a></li>
											<li><a href="/bootstrap/user/right-sidebar.html">Right sidebar</a></li>
											<li><a href="/bootstrap/user/left-sidebar.html">Left sidebar</a></li>
											<li><a href="/bootstrap/user/comingsoon.html">Coming soon</a></li>
											<li><a href="/bootstrap/user/search-result.html">Search result</a></li>
											<li><a href="/bootstrap/user/404.html">404</a></li>
											<li><a href="/bootstrap/user/register.html">Register</a></li>
											<li><a href="/bootstrap/user/login.html">Login</a></li>
										</ul>
									</li>
								</ul>
							</li>
							<li><a href="/bootstrap/user/portfolio.html">Portfolio</a></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Blog <i class="fa fa-angle-down"></i></a>
								<ul class="dropdown-menu">
									<li><a href="/bootstrap/user/blog-rightsidebar.html">Blog right sidebar</a></li>
									<li><a href="/bootstrap/user/blog-leftsidebar.html">Blog left sidebar</a></li>
									<li><a href="/bootstrap/user/post-rightsidebar.html">Post right sidebar</a></li>
									<li><a href="/bootstrap/user/post-leftsidebar.html">Post left sidebar</a></li>
								</ul>
							</li>
							<li><a href="/bootstrap/user/contact.html">Contact</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="main-slider" class="main-slider flexslider">
							<ul class="slides">
								<li>
									<img src="/bootstrap/user/img/slides/flexslider/1.jpg" alt="" />
								...
								<li>
									<img src="/bootstrap/user/img/slides/flexslider/2.jpg" alt="" />
									<div class="flex-caption">
								...
								<li>
									<img src="/bootstrap/user/img/slides/flexslider/3.jpg" alt="" />
									<div class="flex-caption">
										<h3>Clean & Fast</h3>
							...
							<div class="col-sm-6 col-lg-6">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="one">
										<p><img src="/bootstrap/user/img/dummy1.jpg" class="pull-left" alt="" />
									...
									<div class="tab-pane" id="two">
										<p><img src="/bootstrap/user/img/dummy1.jpg" class="pull-right" alt="" /> Tale dolor mea ex, te enim assum suscipit cum, vix aliquid omittantur in. Duo eu cibo dolorum menandri, nam sumo dicit admodum ei. Ne mazim commune honestatis cum, mentitum phaedrum sit
											et.
										</p>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="grid-container" class="cbp-l-grid-projects">
							<ul>
								<li class="cbp-item graphic">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="/bootstrap/user/img/works/1.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="/bootstrap/user/img/works/1big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Dashboard<br>by Paul Flavius Nechita">view larger</a>
												</div>
											</div>
										</div>
									</div>
								...
								<li class="cbp-item web-design logo">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="/bootstrap/user/img/works/2.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="/bootstrap/user/img/works/2big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="World Clock Widget<br>by Paul Flavius Nechita">view larger</a>
												</div>
											</div>
										</div>
									</div>
								...
								<li class="cbp-item graphic logo">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="/bootstrap/user/img/works/3.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
								...
								<li class="cbp-item web-design graphic">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="/bootstrap/user/img/works/4.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="/bootstrap/user/img/works/4big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Events and  More<br>by Tiberiu Neamu">view larger</a>
												</div>
											</div>
										</div>
									</div>
								...
								<li class="cbp-item identity web-design">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="/bootstrap/user/img/works/5.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="/bootstrap/user/img/works/5big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="WhereTO App<br>by Tiberiu Neamu">view larger</a>
												</div>
											</div>
										</div>
									</div>
								...
								<li class="cbp-item identity web-design">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="/bootstrap/user/img/works/6.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="/bootstrap/user/img/works/6big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Ski * Buddy<br>by Tiberiu Neamu">view larger</a>
												</div>
											</div>
										</div>
									</div>
								...
								<li class="cbp-item graphic logo">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="/bootstrap/user/img/works/7.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="/bootstrap/user/img/works/7big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Seemple* Music for iPad<br>by Tiberiu Neamu">view larger</a>
												</div>
											</div>
										</div>
									</div>
								...
								<li class="cbp-item graphic logo">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="/bootstrap/user/img/works/8.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="/bootstrap/user/img/works/8big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Seemple* Music for iPad<br>by Tiberiu Neamu">view larger</a>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="cbp-l-loadMore-button">
							<a href="/bootstrap/user/ajax/loadMore.html" class="cbp-l-loadMore-button-link">LOAD MORE</a>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo" src="/bootstrap/user/img/clients/logo1.png" class="img-responsive" />
					</div>

					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo" src="/bootstrap/user/img/clients/logo2.png" class="img-responsive" />
					</div>

					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo" src="/bootstrap/user/img/clients/logo3.png" class="img-responsive" />
					</div>

					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo" src="/bootstrap/user/img/clients/logo4.png" class="img-responsive" />
					</div>

					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo" src="/bootstrap/user/img/clients/logo5.png" class="img-responsive" />
					</div>
					
					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo" src="/bootstrap/user/img/clients/logo6.png" class="img-responsive" />
					</div>
			...
			<div id="sub-footer">
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							<div class="copyright">
								<p>&copy; HEALTH GUARDIAN - All Right Reserved</p>
							</div>
						</div>
					</div>
				</div>
	...
	<script src="/bootstrap/user/js/jquery.min.js"></script>
	<script src="/bootstrap/user/js/modernizr.custom.js"></script>
	<script src="/bootstrap/user/js/jquery.easing.1.3.js"></script>
	<script src="/bootstrap/user/js/bootstrap.min.js"></script>
	<script src="/bootstrap/user/plugins/flexslider/jquery.flexslider-min.js"></script>
	<script src="/bootstrap/user/plugins/flexslider/flexslider.config.js"></script>
	<script src="/bootstrap/user/js/jquery.appear.js"></script>
	<script src="/bootstrap/user/js/stellar.js"></script>
	<script src="/bootstrap/user/js/classie.js"></script>
	<script src="/bootstrap/user/js/uisearch.js"></script>
	<script src="/bootstrap/user/js/jquery.cubeportfolio.min.js"></script>
	<script src="/bootstrap/user/js/google-code-prettify/prettify.js"></script>
	<script src="/bootstrap/user/js/animate.js"></script>
	<script src="/bootstrap/user/js/custom.js"></script>
