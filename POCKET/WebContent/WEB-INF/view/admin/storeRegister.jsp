                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">가맹점 등록</h4>
                            </div>        
                            <div class="card-body">
								...
								<div>
                                   <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                             ...
                                             <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <label>주소 </label>
                                                    <input type="text" id="jibun_addr" name="jibun_addr" class="form-control" onclick="sample4_execDaumPostcode()" >
                                                </div>
                                            </div>  	
                                        </div>
                                       <div class="row">
                                    ...
                                    <div class="form-actions">                                  		
                                        <button type="submit" class="btn btn-dark btn-outline m-b-10 m-l-5" id="modify"><i class="fa fa-save"></i> SAVE</button>
                                        <button type="button" class="btn btn-dark btn-outline m-b-10 m-l-5" id="golist"><i class="fas fa-history"></i>Go List</button>
                                    </div>
                                    </form>
 								</div>
